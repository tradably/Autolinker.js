...
Autolinker.prototype = {
  ...
  */
	removeUnwantedMatches: function removeUnwantedMatches(matches) {
		...
		if (!this.stockSymbol) remove(matches, function (match) {
			return match.getType() === 'stockSymbol';
		});
...
Autolinker.matcher.StockSymbol = Autolinker.Util.extend(Autolinker.matcher.Matcher, {
  ...
  */
	...
	matcherRegex: /[\$][\(][a-zA-Z0-9_\-=@]{1,12}([\.][a-zA-Z]{1,3})?,[CBEFI]{1}[\)]/g,
...
Autolinker.matcher.Phone = Autolinker.Util.extend(Autolinker.matcher.Matcher, {
  ...
  */
	...
	testMatch: function testMatch(text) {
		return (/\D/.test(text)
		);
	}
...
Autolinker.matcher.Mention = Autolinker.Util.extend(Autolinker.matcher.Matcher, {
  ...
  */
	matcherRegexes: {
		...
		"tradably": new RegExp('@[\(][_. ' + Autolinker.RegexLib.alphaNumericCharsStr + Autolinker.RegexLib.emojiCharStr + ']{2,50},[=' + Autolinker.RegexLib.alphaNumericCharsStr + ']{20}[\)]', 'gu')
	},
