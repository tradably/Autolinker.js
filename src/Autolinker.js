...
Autolinker.prototype = {
	...
	removeUnwantedMatches : function( matches ) {
		...
		if( !this.custom )
			remove( matches, function( match ) { return match.getType() === 'custom'; } );
	...
	getMatchers : function() {
		if( !this.matchers ) {
			...
			var matchers = [
				...
				new matchersNs.Custom( { tagBuilder: tagBuilder, matcherRegex: /[\$][\(][a-zA-Z0-9_\-=@]{1,12}([\.][a-zA-Z]{1,3})?,[CBEFI]{1}[\)]/g } ),
